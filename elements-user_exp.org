...
* The Scope Plane
  ...
  #+CINDEX:specifications, functional
  #+CINDEX:content requirements
  #+CINDEX:requirements, content
  #+CINDEX:user needs
  #+CINDEX:product objectives
...
** Defining the Scope
   ...
   #+CINDEX:scope, defining
   #+CINDEX:process, value
   #+CINDEX:product, value
   ...
   #+CINDEX:reference point, for work
   #+CINDEX:common language, for work
   #+CINDEX:requirements, defining
   #+CINDEX:ambiguity, design process
...
**** Reason #1: So You Know What You Are Building
     ...
     #+CINDEX:requirements, clear, absence of
     ...
     #+CINDEX:requirements, defined set of
     #+CINDEX:responsibility, assign
     #+CINDEX:scope, able to see
     #+CINDEX:connections, individual requirements
     ...
     that might not otherwise be apparent.  For example, in early discussions,
...
**** Reason #2: So You Know What You Are Not Building
     ...
     #+CINDEX:requirements, what not to build
     #+CINDEX:ideas, framework for evaluating
     #+CINDEX:features, fit in
     ...
     #+CINDEX:plans, long term
     #+CINDEX:future releases
     #+CINDEX:releases, future
...
** Functionality and Content
   ...
   #+CINDEX:Web, split between functionality and information, scope plane
   #+CINDEX:product, feature set
   #+CINDEX:product, content
   ...
   *functionality* side, we are concerned with what would be considered the
   ...
   #+CINDEX:content and functionality, differences and similarities
   #+CINDEX:scope, defining
   #+CINDEX:feature, defining
   #+CINDEX:software functions, as feature
   #+CINDEX:content offerings, as feature
   ...
   similar ways.  The term {{{dfn(feature)}}} will refer to both software
   functions, and content offerings.

   #+CINDEX:scope, defining, through functional requirements (specifications)
   #+CINDEX:requirements document
   #+CINDEX:specifications document
   #+CINDEX:documents, requirements
   #+CINDEX:documents, specifications
   ...
   #+CINDEX:functional requirements specification document
   #+CINDEX:functional specifiction document
   #+CINDEX:requirements document
   ...
   are interchangeable---in fact, some people use the term {{{dfn(functional
   requirements specification)}}} just to make sure they've covered all the
   bases.  The author will use
   - {{{dfn(functional specifications)}}}  ::
   ...
   #+CINDEX:language, software development
   #+CINDEX:language, content development
   #+CINDEX:content requirements, process
   #+CINDEX:content developer
   ...
   #+CINDEX:content requirements, functional impications
   #+CINDEX:content management system (CMS)
   #+CINDEX:CMS, content management system
   #+CINDEX:content, pure sites
   ...
   #+CINDEX:CMS, needed functionality
   ...
   #+CINDEX:functional requirements, content implications
...
** Defining Requirements
   ...
   #+CINDEX:requirements, branding
   #+CINDEX:requirements, product as whole
   ...
   #+CINDEX:requirements, specific feature
   ...
   #+CINDEX:requirements, level of detail, scope
   ...
   Conversely, a very large-scale content project might involve such
   ...
   #+CINDEX:requirements, source of
   #+CINDEX:requirements, from users
   #+CINDEX:requirements, from stakeholders
   ...
   #+CINDEX:user research techniques
   In either case, the bast way to find out what people want is simply to ask
   them.  The user research techniques ([[*Usability and User Research%0A][outlined in Chapter 3]]) can all be used
   to help you get a better understanding of the kinds of features users want
   to see in your product.

   Whether you are 1604defining requirements with help from stakeholders inside
